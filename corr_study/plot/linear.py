...
def multi_linear_plot(distribution_data: [np.ndarray],
    ...
    # plt.savefig(output_file.replace(" ", "_") + '.png', bbox_inches='tight')
    # tikzplotlib.save(output_file.replace(" ", "_") + '.tex')
    # with open(output_file.replace(" ", "_") + '_fig.pkl', 'wb') as fig_out_file:
    #     pickle.dump(fig, fig_out_file)
    # with open(output_file.replace(" ", "_") + '_ax.pkl', 'wb') as ax_out_file:
    #     pickle.dump(ax, ax_out_file)
    # 
    # if plot_format == 'tex':
    #     tikzplotlib.save(output_file.replace(" ", "_") + '.tex')
    # 
